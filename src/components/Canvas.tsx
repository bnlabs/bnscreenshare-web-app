...
//       <div className="flex flex-col p-5 w-72 bg-slate-500" id="toolbar" onChange={handleToolbar}>
...
//       <canvas
//         className='bg-transparent h-5/6 rounded-lg border-solid border-gray-600 border-8'
//         ref={canvasRef}
